...
public String admnpagecheck(ModelMap map,@ModelAttribute("username")String username,@ModelAttribute("password")String password) {
...
public String usercheck(ModelMap map,@ModelAttribute("email")String cemail,@ModelAttribute("password")String cpassword) {
...
public String bookpage(ModelMap map,@ModelAttribute("uid")int uid,@ModelAttribute("pid")int pid,@ModelAttribute("price")int price) {
...
@GetMapping("/payment")
public String paymentpage(ModelMap map,@ModelAttribute("uid")int uid,@ModelAttribute("pid")int pid,@ModelAttribute("price")int price) {
...
public String confirmationpage(ModelMap map,@ModelAttribute("uid")int uid,@ModelAttribute("pid")int pid,@ModelAttribute("price")int price) {
...
public String sppurchase(ModelMap map,@ModelAttribute("category")String category,@ModelAttribute("date")String date) {
...
public String insertproduct(ModelMap map,@ModelAttribute("category")String cat,@ModelAttribute("price")int price,@ModelAttribute("brandname")String bn,@ModelAttribute("color")String color,@ModelAttribute("mt")String mt) {
